...
const Carousel = () => {
    ...
    const slides = [
        { url: 'https://i.imgur.com/OfEd7eC.png', alt: 'Slide 1' },
    ...
    */];
    ...
    return (
        ...
        <button
            ...
            className="absolute left-0 top-1/2 transform -translate-y-1/2  text-black p-2 rounded-full text-3xl md:text-4xl"
        >
        ...
        <button
            ...
            className="absolute right-0 top-1/2 transform -translate-y-1/2  text-black p-2 rounded-full text-3xl md:text-4xl"
        >
